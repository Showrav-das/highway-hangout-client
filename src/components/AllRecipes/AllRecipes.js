...
const AllRecipes = () => {
  ...
  return (
    <>
      ...
      <div
        id="recipes"
        className="container w-100 m-auto p-5 animate__animated animate__jello"
      >
        {/* title starts */}
          ...
          {services?.map((service) => (
            <div key={service._id} className="col-md-6 col-lg-4 col-sm-12">
              <div className="cart service p-3 m-2 border border">
                ...
                {/* service info starts  */}
                <h4 className="mt-4 service-info">
                  <b>{service.name.slice(0, 22)}</b>
                </h4>

                <h5 className="mt-4 service-info">
                  {" "}
                ...
                <p>
                  {" "}
                  <b>Cooking Time: {service.cookingTime}</b>
                </p>

                <p>
                  {" "}
                  <b>Serves: {service.serves} </b>
                </p>
