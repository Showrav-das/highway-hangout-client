    ...
    <>
      <Navbar bg="dark" variant="dark">
        <Container className="d-flex flex-column flex-lg-row">
          ...
          <Nav className="flex-column text-center">
            <h4 className="fs-5" style={{ color: "orange" }}>
              Links
            </h4>
          ...
          <Nav className="flex-column align-items-center my-3">
            <h4 className="fs-5 mb-0 border-bottom" style={{ color: "orange" }}>
              Contact us
            </h4>
            <div className="fs-6 lh-sm text-white mt-3">
              <p className="mb-1">
                <BsGeoAlt />
                &nbsp;&nbsp;92/A, Dhaka - 1000, Bangladesh
              </p>
              <p className="mb-1">
                <BsEnvelope />
                &nbsp;&nbsp;contact@highwayhangouts.com
              </p>
              <p className="mb-0">
                <BsTelephone />
                &nbsp;&nbsp;+880123456789, +88087654321
              </p>
            </div>
            <h4
              className="mt-2 fs-5 mb-0 border-bottom"
              style={{ color: "orange" }}
            >
              Follow us
            </h4>
          ...
          <Nav className="flex-column align-items-center">
            <h4 className="fs-5 mb-3" style={{ color: "orange" }}>
              We accept
            </h4>
      ...
      <Navbar bg="secondary" variant="dark">
        <Navbar.Text className="text-white mx-auto">
          &copy; 2022, Highway Hangouts. All Rights Reserved.
        </Navbar.Text>
      </Navbar>
    </>
  );
